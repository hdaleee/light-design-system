...
export const headerBold = css<{ $useRem: boolean }>`
  font-size: ${({ theme, $useRem }) => theme.spacing[lastCharToUpperCase('spacing_h', $useRem) as SpacingSizeType]};
  font-weight: bold;
`;
...
export const bodyBold = css<{ $useRem: boolean }>`
  font-size: ${({ theme, $useRem }) => theme.spacing[lastCharToUpperCase('spacing_d', $useRem) as SpacingSizeType]};
  font-weight: bold;
`;
